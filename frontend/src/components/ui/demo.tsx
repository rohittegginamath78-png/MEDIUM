...
export default function Hero() {
  return (
    <section className="relative pt-20 flex h-screen w-full  flex-col items-start justify-center overflow-hidden">
      ...
      <div className="relative  z-10 w-full px-5 pb-14 text-white sm:px-8 sm:pb-20 lg:px-16">
        <div className="mx-auto grid w-full max-w-6xl gap-8 md:grid-cols-[1.15fr_0.85fr] md:items-center">
          <div className="space-y-5">
            ...
            <div className="flex flex-wrap items-center gap-3 pt-1">
              <Button className="rounded-full bg-primary px-5 py-2.5 text-black hover:opacity-95">
                Get started
                <span className="ml-1 inline-flex rounded-full bg-black/10 p-1">
                  <ArrowRight className="size-4" />
                </span>
              </Button>
              <a
                href="/blogs"
                className="rounded-full border border-white/15 bg-white/5 px-5 py-2.5 text-sm font-medium text-white/90 backdrop-blur transition hover:bg-white/10"
              >
                Explore posts
              </a>
            </div>
          ...
          <div className="md:justify-self-end">
            <div className="w-full max-w-md rounded-2xl border border-white/10 bg-black/40 p-5 backdrop-blur">
